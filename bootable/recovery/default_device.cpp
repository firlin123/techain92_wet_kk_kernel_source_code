...
static const char* HEADERS[] = { "Volume up to move highlight;",
                                 "enter volume down to select.",
                                 "",
                                 NULL };
...
static const char* ITEMS[] =  {"reboot system now",
                               ...
                               NULL };
#else
static const char* ITEMS[] =  {"apply update from sdcard",
                               "apply update from ADB",
                               "reboot system now",
